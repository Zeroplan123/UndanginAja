<x-app-layout>
<x-slot name="title">Buat Broadcast</x-slot>
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Create New Broadcast</h1>
    ...
    <form method="POST" action="{{ route('admin.broadcasts.store') }}" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select id="type" name="type" required
                    ...
                    <option value="update" {{ old('type') === 'update' ? 'selected' : '' }}>Feature Update</option>
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="message" name="message" rows="6" required
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Enter your broadcast message...">{{ old('message') }}</textarea>
            ...
            <!-- User Selection -->
            <div id="user-selection" class="md:col-span-2 {{ old('target_type') === 'specific' ? '' : 'hidden' }}">
        ...
        <div class="flex justify-end space-x-3 mt-6 pt-6 border-t border-gray-200">
            ...
            <button type="submit" 
                ...
                <i class="fas fa-save mr-2"></i>Create Broadcast
            </button>
        </div>
    </form>
</div>
