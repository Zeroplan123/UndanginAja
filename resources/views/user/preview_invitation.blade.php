                ...
                <div class="bg-white rounded-lg shadow-md p-4">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <button onclick="shareToWhatsApp()" 
                                class="flex flex-col items-center space-y-1 bg-green-500 hover:bg-green-600 text-white p-3 rounded-lg transition-colors duration-200">
                ...
                <div class="xl:col-span-1 order-1 xl:order-2 space-y-4 sm:space-y-6">
                    ...
                    <div class="hidden sm:block bg-white overflow-hidden shadow-xl rounded-lg sm:rounded-2xl">
                        <div class="p-4 sm:p-6">
                            ...
                            <div class="space-y-2">
                                <button onclick="shareToWhatsApp()" 
                                        class="w-full inline-flex items-center justify-center space-x-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 text-sm">
